...
if ( ! class_exists( 'TR_Admin_Page_Class_V6') ) :
 ...
 */
  ...
  class TR_Admin_Page_Class_V6 {
    ...
    public function __construct($args) {
        if(!isset($args['fields']) || !is_array($args['fields']))$args['fields'] = array();
        if(isset($args['path']))
        {
  ...
  public function show_field_repeater( $field, $meta ) {
    ...
    echo '<script>
        jQuery(document).ready(function($) {
          var '.$counter.' = '.$c.';
          $("#add-'.$jsid.'").live(\'click\', function() {
            '.$counter.' = '.$counter.' + 1;
            $(this).before(\''.$js_code.'\');            
            update_repeater_fields();
          });
              $("#remove-'.$jsid.'").live(\'click\', function() {
                  $(this).parent().remove();
              });
          });
        </script>';            
